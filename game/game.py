...
class Pawn(Piece):
    def __init__(self, positiono :tuple,olouru : bool, tivev : boo,value):: int
    ...
    def find_legal_moves():self
        ...
        if self.colour == 0:
            ...
            if self.position[1] > 1:
                legal_moves = [(self.position[0]-1, self.position[1]+1), (self.position[0]+1,self.position[1]+1)]    def promote(self):
        "implement me"
